...
export const enContent: LandingContent = {
  ...
  nav: {
    links: [
      ...
      { label: "GitHub", href: "https://git.moleculesai.app/molecule-ai" },
    ],
    signIn: "Sign In",
    openCanvas: "Sign In",
  },
  ...
  adapters: {
    ...
    cards: [
      ...
      },
      {
        ...
        items: ["MCP tools", "OpenTelemetry", "Langfuse", "Sentry · Prometheus"],
      },
    ],
  },
  pillars: {
  ...
  whatShips: {
    ...
    columns: [
      ...
      },
      {
        label: "Platform",
        name: "Control Plane",
        stack: "Go 1.25 · Gin · Postgres · Python 3.11 · AWS EC2 · Railway",
        items: [
  ...
  comparison: {
    ...
    rows: [
      ...
      ["Audit trail · EU AI Act ready", "✓", "partial", "partial", "partial"],
      ["HITL tiers", "✓", "—", "—", "partial"],
...
export const zhContent: LandingContent = {
  ...
  adapters: {
    ...
    cards: [
      ...
      },
      {
        ...
        headline: "面向标准的管道。",
        detail:
          "MCP 接工具,OpenTelemetry 收追踪,Langfuse 做 Prompt 级评估,Sentry + Prometheus 接运维告警。",
        items: ["MCP 工具", "OpenTelemetry", "Langfuse", "Sentry · Prometheus"],
      },
    ],
  },
  pillars: {
  ...
  whatShips: {
    ...
    columns: [
      ...
      },
      {
        ...
        stack: "Go 1.25 · Gin · Postgres · Python 3.11 · AWS EC2 · Railway",
        items: [
          "带忙等重试队列的 JSON-RPC 2.0 A2A 路由",
          "三层内存存储(LOCAL / TEAM / GLOBAL)",
          "WorkOS OAuth · AES-256-GCM KMS 信封",
  ...
  comparison: {
    ...
    rows: [
      ...
      ["A2A 协议", "✓", "—", "—", "—"],
      ["三层市场", "✓", "—", "—", "—"],
      ["审计 · EU AI Act 就绪", "✓", "partial", "partial", "partial"],
      ["分级 HITL", "✓", "—", "—", "partial"],
      ["组织模板版本化", "✓", "—", "—", "—"],
    ],
  },
...
export const frContent: LandingContent = {
  ...
  adapters: {
    ...
    cards: [
      ...
      },
      {
        ...
        items: ["Outils MCP", "OpenTelemetry", "Langfuse", "Sentry · Prometheus"],
      },
    ],
  },
  pillars: {
  ...
  comparison: {
    ...
    rows: [
      ...
      ["Piste d'audit · prêt EU AI Act", "✓", "partiel", "partiel", "partiel"],
...
export const jaContent: LandingContent = {
  ...
  adapters: {
    ...
    cards: [
      ...
      },
      {
        ...
        headline: "標準ファーストの配管。",
        detail:
          "ツールには MCP、トレースには OpenTelemetry、プロンプト レベルの評価には Langfuse、運用アラートには Sentry + Prometheus。",
        items: ["MCP ツール", "OpenTelemetry", "Langfuse", "Sentry · Prometheus"],
      },
    ],
  },
  pillars: {
    ...
    columns: [
      {
        ...
        stack: "Next.js 15 · React Flow · Zustand",
        items: [
          "組織テンプレート対応のビジュアル トポロジー エディタ",
          "キャンバス上にライブ A2A トレースをオーバーレイ",
          "ワン クリックでプラグインと組織バンドルをインストール",
      ...
      },
      {
        ...
        stack: "Go 1.25 · Gin · Postgres · Python 3.11 · AWS EC2 · Railway",
        items: [
          "ビジー リトライ キュー付き JSON-RPC 2.0 A2A ルーター",
          "3 層メモリ ストア(LOCAL / TEAM / GLOBAL)",
          "WorkOS OAuth · AES-256-GCM KMS エンベロープ",
  ...
  comparison: {
    ...
    rows: [
      ...
      ["A2A プロトコル", "✓", "—", "—", "—"],
      ["3 層 Marketplace", "✓", "—", "—", "—"],
      ["監査ログ · EU AI Act 対応", "✓", "partial", "partial", "partial"],
      ["HITL ティア", "✓", "—", "—", "partial"],
      ["組織テンプレートのバージョン管理", "✓", "—", "—", "—"],
    ],
  },
...
export const esContent: LandingContent = {
  ...
  adapters: {
    ...
    cards: [
      ...
      },
      {
        ...
        detail:
          "MCP para herramientas. OpenTelemetry para trazas. Langfuse para eval a nivel de prompt. Sentry + Prometheus para alertas de operación.",
        items: ["Herramientas MCP", "OpenTelemetry", "Langfuse", "Sentry · Prometheus"],
      },
    ],
  },
  pillars: {
    ...
    columns: [
      {
        ...
        stack: "Next.js 15 · React Flow · Zustand",
        items: [
          "Editor visual de topología con plantillas de org",
          "Overlay de trazas A2A en vivo sobre el canvas",
          "Instalación en un clic de plugins y bundles de org",
      ...
      },
      {
        ...
        stack: "Go 1.25 · Gin · Postgres · Python 3.11 · AWS EC2 · Railway",
        items: [
          "Router A2A JSON-RPC 2.0 con cola de reintentos",
          "Almacén de memoria de tres niveles (LOCAL/TEAM/GLOBAL)",
          "OAuth de WorkOS · sobres de secretos AES-256-GCM KMS",
  ...
  comparison: {
    ...
    rows: [
      ...
      ["Trazabilidad de auditoría · listo para EU AI Act", "✓", "parcial", "parcial", "parcial"],
